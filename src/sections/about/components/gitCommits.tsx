...
export const GitCommits = () => {
    ...
    return (
        <div className="gitCommits flex w-full max-w-[45rem] mx-auto h-fit min-h-fit text-black bg-white text-center rounded-[.3rem] shadow-[0_3px_10px_rgba(0,0,0,.05)] dark:shadow-[0_3px_10px_rgba(255,255,255,.05)] border-[.02rem] border-[rgba(65,65,65,.5)]  flex-col justify-between py-[1.2rem] whitespace-nowrap overflow-hidden">
            ...
            <ul className="flex flex-col justify-between h-full">
                {data.map((item: any) => (
                    ...
                    >
                        ...
                        <span className="font-regular whitespace-nowrap px-5 overflow-hidden text-xxs text-left w-full">
