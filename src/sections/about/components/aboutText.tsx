export const AboutText = () => {
    return (
        <div className="aboutText w-full font-regular text-black dark:text-white">
            ...
            <p className="text-xs tablet:text-sm mt-5">
                <span className="text-xs tablet:text-sm font-semiBold block">
                    Have a job opportunity, project idea, or need freelance web
                    work performed?
                </span>
                Feel free to contact me through any of the platforms listed with
